...
request.onload = function() {
  if (request.status >= 200 && request.status < 400){
    ...
    document.getElementById('widgetchiras').innerHTML='<link rel="stylesheet" type="text/css" href="https://cdn.rawgit.com/EscuelaDeDatos/widgetElCaracol/master/sexy.css"><div class="social_widget" onclick="window.open(\' ' + url + ' \', \'_blank\')"><div class="wid_card">' + chirasview + '</div></div>';
  } 
};
